    ...
    <header class="header">
        <div class="container">
            ...
            <div class="header-menu">
                <button style="button" class="btn btn--styless header-menu__hamburger" :class="{ 'is-toggled': hamburgerToggled }" @click="hamburgerToggled = !hamburgerToggled">
                    <span></span>
                    <span></span>
                    <span></span>
                </button>
                <div class="header-menu-controls-wrapper" :class="{ 'is-toggled': hamburgerToggled }">
                    <Transition>
