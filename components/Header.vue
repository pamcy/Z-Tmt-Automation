                ...
                <div class="header-menu-controls-wrapper">
                    ...
                    <Transition>
                        <div class="header-menu-controls" v-show="hamburgerToggled">
                            ...
                            <form class="d-none d-lg-flex header-menu-controls__search-desktop" ref="searchForm" @submit.prevent="search()">
                                ...
                                <Transition>
                                    <div class="input-group" v-if="desktopSearchBarToggled">
                                        ...
                                        <button type="button" class="btn btn-styless" @click="clearSearchValue()">
                                            <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg"><title>Search</title><rect x="20.809" y="17.98" width="30" height="4" rx="2" transform="rotate(45 20.809 17.98)" fill="#EE7B45"/><rect width="30" height="4" rx="2" transform="scale(-1 1) rotate(45 -41.3 -38.32)" fill="#EE7B45"/></svg>
                                        </button>
                                    </div>
                                </Transition>
                            </form>
...
onMounted(() => {
    if (window.matchMedia('(min-width: 990px)').matches) {
        ...
        window.addEventListener('click', (e) => {
            if (!searchForm.value.contains(e.target)) {
