<template>
    <form action="" class="search-box" @submit.prevent="handleSubmit">
        <div class="input-group">
            <input type="search" v-model="searchTerm" placeholder="Type keyword" />
...
function handleSubmit() {
    ...
    window.location.href = `/support/faq-result?search=${searchTerm.value}`
}
</script>
